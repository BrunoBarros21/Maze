...
public class TestMazeBuilder {
	...
	public void testRandomMazeGenerator() throws IllegalArgumentException {
		int numMazes = 10; // number of mazes to generate and test
		int maxMazeSize = 23; // can change to any odd number >= 5
		int minMazeSize = 5;
		...
		for (int i = 0; i < numMazes; i++) {
			...
			MazeGenerator builder = new MazeGenerator(size, size, 1);
			builder.startMaze();
